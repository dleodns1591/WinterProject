...
public class UI_BOSS_4 : MonoBehaviour
{
    ...
    public void OnClickBoss4()
    {
        ...
        else if (oc.Boss_Four_Num == 1)
        {
            ...
            Nomal_Boss_1.gameObject.SetActive(true);
            Nomal_Boss_2.gameObject.SetActive(false);
            Nomal_Boss_3.gameObject.SetActive(false);
            Nomal_Boss_4.gameObject.SetActive(true); //할성화
            Nomal_Boss_5.gameObject.SetActive(false);
            Nomal_Boss_6.gameObject.SetActive(false);
            audioSource.Play();
        }
