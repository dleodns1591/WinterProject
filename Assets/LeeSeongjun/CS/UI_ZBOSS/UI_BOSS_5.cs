...
public class UI_BOSS_5 : MonoBehaviour
{
    ...
    public void OnClickBoss5()
    {
        ...
        if (oc.Boss_Five_Num == 0)
        {
            ...
            Black_Boss_5.gameObject.SetActive(true); //활성화
        ...
        else if (oc.Boss_Five_Num == 1)
        {
            ...
            Nomal_Boss_3.gameObject.SetActive(false);
            Nomal_Boss_4.gameObject.SetActive(false);
            Nomal_Boss_5.gameObject.SetActive(true); //할성화
            Nomal_Boss_6.gameObject.SetActive(false);
            audioSource.Play();
        }
    }
